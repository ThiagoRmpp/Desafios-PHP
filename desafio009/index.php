...
<body>
    ...
    ?>
    <main>
        <h1>Médias Aritmédicas e Ponderadas</h1>
    ...
    <section>
        ...
        <ul>
            <li>A <strong>Média Aritmédica Simples</strong> entre os valores é igual a <?=number_format($ma, 2, ",", ".")?>.</li>
            <li>A <strong>Média Aritmédica Ponderada</strong> com pesos <?=$peso1?> e <?=$peso2?> é igual a <?=number_format($mp, 2, ",", ".")?>.</li>
        </ul>
    </section>
</body>
</html>